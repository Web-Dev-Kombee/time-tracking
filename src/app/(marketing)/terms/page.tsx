export const metadata = {
 ...
 description: "Terms and Conditions for using TimeTracker time tracking and billing application",
};
 ...
 return (
  <div className="container max-w-4xl py-12">
   ...
   <div className="prose dark:prose-invert max-w-none">
    <p>
     These Terms of Service ("Terms") govern your use of TimeTracker (the "Service") operated by
     TimeTracker Inc. ("we", "us", or "our"). By accessing or using the Service, you agree to be
     bound by these Terms. If you disagree with any part of the Terms, you may not access the
     Service.
    </p>
    ...
    <p>
     Some features of the Service are billed on a subscription basis ("Subscription(s)"). You will
     be billed in advance on a recurring and periodic basis ("Billing Cycle"). Billing cycles are
     set on a monthly or annual basis, depending on the type of subscription plan you select.
    </p>
    <p>
    ...
    <p>
     All payments are non-refundable except as expressly set forth in our Refund Policy or as
     required by applicable law.
    </p>

    <h2>3. Free Trial</h2>
    <p>
     We may, at our sole discretion, offer a Subscription with a free trial for a limited period of
     time ("Free Trial"). You may be required to enter your billing information to sign up for the
     Free Trial.
    </p>
    <p>
     ...
     canceled your Subscription, you will be automatically charged the applicable subscription fee
    ...
    <p>
     ...
     exclusive property of TimeTracker Inc. and its licensors. The Service is protected by
     copyright, trademark, and other laws.
    </p>
    <p>
     You retain any and all of your rights to any data you submit, post, or display on or through
     the Service ("User Content"). By submitting, posting or displaying User Content on or through
     the Service, you grant us a worldwide, non-exclusive, royalty-free license to use, reproduce,
     adapt, publish, translate, and distribute your User Content in connection with providing and
     improving the Service.
    </p>

    <h2>5. Limitation of Liability</h2>
    <p>
     In no event shall TimeTracker Inc., nor its directors, employees, partners, agents, suppliers,
    ...
    <p>
     ...
     terminate your account, you may simply discontinue using the Service or delete your account
    ...
    <p>
     ...
     those rights. If any provision of these Terms is held to be invalid or unenforceable by a
