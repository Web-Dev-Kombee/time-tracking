   ...
   <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
    ...
    <div className="border rounded-lg p-6 flex flex-col h-full">
     <div className="mb-6">
      ...
      <p className="text-muted-foreground">Basic time tracking for freelancers just starting out</p>
     </div>
    ...
    <div className="border rounded-lg p-6 flex flex-col h-full">
     <div className="mb-6">
      ...
      <p className="text-muted-foreground">Advanced features for growing businesses and agencies</p>
     </div>
     <ul className="space-y-3 mb-8">
   ...
   <div>
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
     ...
     <div className="space-y-2">
      ...
      <p className="text-muted-foreground">
       Your 14-day free trial includes all features of the plan you choose. No credit card required
