 ...
 return (
  <div className="container max-w-6xl py-12 md:py-16 lg:py-24">
   <div className="text-center mb-12 md:mb-16">
    <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6">See TimeTracker in Action</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
       <div>
        ...
        <p className="text-muted-foreground mb-6">
         Track time with a single click. Add detailed notes, categorize by client or project, and
     ...
     <TabsContent value="projects" className="mt-6">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
       <div>
        ...
        <p className="text-muted-foreground mb-6">
         Create projects, set budgets, track deadlines, and monitor progress. Assign team members
     ...
     <TabsContent value="invoicing" className="mt-6">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
       <div>
        ...
        <p className="text-muted-foreground mb-6">
         Create professional invoices from tracked time and expenses. Customize templates, set
         payment terms, and accept online payments.
        </p>
        <ul className="space-y-2">
         <li className="flex items-center">
          <div className="h-2 w-2 rounded-full bg-primary mr-2"></div>
