    ...
    <>
     <div className="grid gap-6 grid-cols-1 md:grid-cols-4 mb-6">
      ...
      <Card>
       ...
       <CardContent>
        <div className="text-2xl font-bold text-green-600">${report.paidTotal.toFixed(2)}</div>
        <p className="text-xs text-muted-foreground">
         {report.outstandingTotal > 0 && `$${report.outstandingTotal.toFixed(2)} outstanding`}
        </p>
       </CardContent>
      </Card>
     </div>
         ...
         <tbody>
          {report.clientStats.map((client: any) => (
           <tr key={client.id} className="border-b hover:bg-muted/50">
            ...
            <td className="py-3 px-4 text-right">${client.billableAmount.toFixed(2)}</td>
            <td className="py-3 px-4 text-right">${client.expenses.toFixed(2)}</td>
            <td className="py-3 px-4 text-right">${client.invoicedAmount.toFixed(2)}</td>
            <td className="py-3 px-4 text-right">${client.paidAmount.toFixed(2)}</td>
            <td className="py-3 px-4 text-right">${client.outstandingAmount.toFixed(2)}</td>
           </tr>
          ))}
         </tbody>
         <tfoot>
          <tr className="bg-muted">
           ...
           <th className="py-3 px-4 text-right">${report.billableExpenses.toFixed(2)}</th>
           ...
           <th className="py-3 px-4 text-right">${report.outstandingTotal.toFixed(2)}</th>
          </tr>
         </tfoot>
        </table>
       </div>
